...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      5c:	4509                	li	a0,2
      5e:	024010ef          	jal	1082 <fprintf>
  exit(1);
      62:	4505                	li	a0,1
      64:	3e1000ef          	jal	c44 <exit>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      d6:	3a7000ef          	jal	c7c <exec>
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      da:	6490                	ld	a2,8(s1)
      dc:	00001597          	auipc	a1,0x1
      e0:	1ac58593          	addi	a1,a1,428 # 1288 <malloc+0x128>
      e4:	4509                	li	a0,2
      e6:	79d000ef          	jal	1082 <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
      ec:	359000ef          	jal	c44 <exit>
      exit(1);
      f0:	4505                	li	a0,1
      f2:	353000ef          	jal	c44 <exit>
    close(rcmd->fd);
      f6:	5148                	lw	a0,36(a0)
      f8:	375000ef          	jal	c6c <close>
    if(open(rcmd->file, rcmd->mode) < 0){
      fc:	508c                	lw	a1,32(s1)
      fe:	6888                	ld	a0,16(s1)
     100:	385000ef          	jal	c84 <open>
    ...
    runcmd(rcmd->cmd);
     ...
     118:	4509                	li	a0,2
     11a:	769000ef          	jal	1082 <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
     120:	325000ef          	jal	c44 <exit>
    if(fork1() == 0)
    ...
    if(fork1() == 0){
     ...
     14c:	e90d                	bnez	a0,17e <runcmd+0xf0>
      close(1);
     14e:	4505                	li	a0,1
     150:	31d000ef          	jal	c6c <close>
      dup(p[1]);
     154:	fdc42503          	lw	a0,-36(s0)
     158:	365000ef          	jal	cbc <dup>
      close(p[0]);
     15c:	fd842503          	lw	a0,-40(s0)
     160:	30d000ef          	jal	c6c <close>
      close(p[1]);
     164:	fdc42503          	lw	a0,-36(s0)
     168:	305000ef          	jal	c6c <close>
      runcmd(pcmd->left);
     16c:	6488                	ld	a0,8(s1)
    ...
    if(fork1() == 0){
     ...
     182:	e115                	bnez	a0,1a6 <runcmd+0x118>
      close(0);
     184:	2e9000ef          	jal	c6c <close>
      dup(p[0]);
     188:	fd842503          	lw	a0,-40(s0)
     18c:	331000ef          	jal	cbc <dup>
      close(p[0]);
     190:	fd842503          	lw	a0,-40(s0)
     194:	2d9000ef          	jal	c6c <close>
      close(p[1]);
     198:	fdc42503          	lw	a0,-36(s0)
     19c:	2d1000ef          	jal	c6c <close>
      runcmd(pcmd->right);
     1a0:	6888                	ld	a0,16(s1)
     1a2:	eedff0ef          	jal	8e <runcmd>
    close(p[0]);
     1a6:	fd842503          	lw	a0,-40(s0)
     1aa:	2c3000ef          	jal	c6c <close>
    close(p[1]);
     1ae:	fdc42503          	lw	a0,-36(s0)
     1b2:	2bb000ef          	jal	c6c <close>
    wait(0);
     1b6:	4501                	li	a0,0
     1b8:	295000ef          	jal	c4c <wait>
    wait(0);
     1bc:	4501                	li	a0,0
     1be:	28f000ef          	jal	c4c <wait>
    break;
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	e04a8a93          	addi	s5,s5,-508 # 12d0 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	dd250513          	addi	a0,a0,-558 # 12b0 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d3e60613          	addi	a2,a2,-706 # 12d8 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d2eb0b13          	addi	s6,s6,-722 # 12f8 <malloc+0x198>
  ...
  return ret;
     ...
     5f8:	cec50513          	addi	a0,a0,-788 # 12e0 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	ca250513          	addi	a0,a0,-862 # 12e8 <malloc+0x188>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c7c60613          	addi	a2,a2,-900 # 1300 <malloc+0x1a0>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c28a0a13          	addi	s4,s4,-984 # 1308 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	c0660613          	addi	a2,a2,-1018 # 1310 <malloc+0x1b0>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b7860613          	addi	a2,a2,-1160 # 12d8 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	ba460613          	addi	a2,a2,-1116 # 1328 <malloc+0x1c8>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b5e50513          	addi	a0,a0,-1186 # 1318 <malloc+0x1b8>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b6a50513          	addi	a0,a0,-1174 # 1330 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	ba270713          	addi	a4,a4,-1118 # 1390 <malloc+0x230>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9ee60613          	addi	a2,a2,-1554 # 1268 <malloc+0x108>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	aa058593          	addi	a1,a1,-1376 # 1348 <malloc+0x1e8>
     8b0:	4509                	li	a0,2
     8b2:	7d0000ef          	jal	1082 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a2a50513          	addi	a0,a0,-1494 # 12e0 <malloc+0x180>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a8248493          	addi	s1,s1,-1406 # 1358 <malloc+0x1f8>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
     8e2:	3a2000ef          	jal	c84 <open>
     8e6:	00054763          	bltz	a0,8f4 <main+0x32>
    if(fd >= 3){
     8ea:	4789                	li	a5,2
     8ec:	fea7d9e3          	bge	a5,a0,8de <main+0x1c>
      close(fd);
     8f0:	37c000ef          	jal	c6c <close>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     96e:	8526                	mv	a0,s1
     970:	344000ef          	jal	cb4 <chdir>
     974:	fc0552e3          	bgez	a0,938 <main+0x76>
        fprintf(2, "cannot cd %s\n", cmd+3);
     978:	8626                	mv	a2,s1
     97a:	00001597          	auipc	a1,0x1
     97e:	9e658593          	addi	a1,a1,-1562 # 1360 <malloc+0x200>
     982:	4509                	li	a0,2
     984:	6fe000ef          	jal	1082 <fprintf>
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
     aec:	85ca                	mv	a1,s2
     aee:	1ae000ef          	jal	c9c <fstat>
     af2:	892a                	mv	s2,a0
  close(fd);
     af4:	8526                	mv	a0,s1
     af6:	176000ef          	jal	c6c <close>
  return r;
     afa:	64a2                	ld	s1,8(sp)
}
     afc:	854a                	mv	a0,s2
...
ugetpid(void)
{
  ...
  return u->pid;
     c2c:	040007b7          	lui	a5,0x4000
     c30:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffdf75>
     c32:	07b2                	slli	a5,a5,0xc
}
     c34:	4388                	lw	a0,0(a5)
     c36:	6422                	ld	s0,8(sp)
...
0000000000000cfc <recv>:
.global recv
recv:
 li a7, SYS_recv
     cfc:	02000893          	li	a7,32
 ecall
     d00:	00000073          	ecall
 ret
     d04:	8082                	ret

0000000000000d06 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
     d06:	02100893          	li	a7,33
 ecall
     d0a:	00000073          	ecall
 ret
     d0e:	8082                	ret

0000000000000d10 <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
     d10:	02200893          	li	a7,34
 ecall
     d14:	00000073          	ecall
 ret
     d18:	8082                	ret

0000000000000d1a <prac>:
.global prac
prac:
 li a7, SYS_prac
     d1a:	02300893          	li	a7,35
 ecall
     d1e:	00000073          	ecall
 ret
     d22:	8082                	ret

0000000000000d24 <putc>:
...
putc(int fd, char c)
{
     ...
     d2c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     d30:	4605                	li	a2,1
     d32:	fef40593          	addi	a1,s0,-17
     d36:	f2fff0ef          	jal	c64 <write>
}
...
0000000000000d42 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     d42:	715d                	addi	sp,sp,-80
     d44:	e486                	sd	ra,72(sp)
     d46:	e0a2                	sd	s0,64(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     d4e:	c299                	beqz	a3,d54 <printint+0x12>
     d50:	0805c363          	bltz	a1,dd6 <printint+0x94>
  neg = 0;
     d54:	4881                	li	a7,0
     d56:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d60:	64c50513          	addi	a0,a0,1612 # 13a8 <digits>
     d64:	883e                	mv	a6,a5
     d66:	2785                	addiw	a5,a5,1
     d68:	02c5f733          	remu	a4,a1,a2
     d6c:	972a                	add	a4,a4,a0
     d6e:	00074703          	lbu	a4,0(a4)
     d72:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d76:	872e                	mv	a4,a1
     d78:	02c5d5b3          	divu	a1,a1,a2
     d7c:	0685                	addi	a3,a3,1
     d7e:	fec773e3          	bgeu	a4,a2,d64 <printint+0x22>
  if(neg)
     d82:	00088b63          	beqz	a7,d98 <printint+0x56>
    buf[i++] = '-';
     d86:	fd078793          	addi	a5,a5,-48
     d8a:	97a2                	add	a5,a5,s0
     d8c:	02d00713          	li	a4,45
     d90:	fee78423          	sb	a4,-24(a5)
     d94:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d98:	02f05a63          	blez	a5,dcc <printint+0x8a>
     d9c:	fc26                	sd	s1,56(sp)
     d9e:	f44e                	sd	s3,40(sp)
     da0:	fb840713          	addi	a4,s0,-72
     da4:	00f704b3          	add	s1,a4,a5
     da8:	fff70993          	addi	s3,a4,-1
     dac:	99be                	add	s3,s3,a5
     dae:	37fd                	addiw	a5,a5,-1
     db0:	1782                	slli	a5,a5,0x20
     db2:	9381                	srli	a5,a5,0x20
     db4:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     db8:	fff4c583          	lbu	a1,-1(s1)
     dbc:	854a                	mv	a0,s2
     dbe:	f67ff0ef          	jal	d24 <putc>
  while(--i >= 0)
     dc2:	14fd                	addi	s1,s1,-1
     dc4:	ff349ae3          	bne	s1,s3,db8 <printint+0x76>
     dc8:	74e2                	ld	s1,56(sp)
     dca:	79a2                	ld	s3,40(sp)
}
     dcc:	60a6                	ld	ra,72(sp)
     dce:	6406                	ld	s0,64(sp)
     dd0:	7942                	ld	s2,48(sp)
     dd2:	6161                	addi	sp,sp,80
     dd4:	8082                	ret
    x = -xx;
     dd6:	40b005b3          	neg	a1,a1
    neg = 1;
     dda:	4885                	li	a7,1
    x = -xx;
     ddc:	bfad                	j	d56 <printint+0x14>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     edc:	855a                	mv	a0,s6
     ede:	e47ff0ef          	jal	d24 <putc>
        putc(fd, c0);
     ee2:	85ca                	mv	a1,s2
     ee4:	855a                	mv	a0,s6
     ee6:	e3fff0ef          	jal	d24 <putc>
      state = 0;
     eea:	4981                	li	s3,0
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1058:	31c90913          	addi	s2,s2,796 # 1370 <malloc+0x210>
        for(; *s; s++)
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    10ec:	f287b783          	ld	a5,-216(a5) # 2010 <freep>
    ...
    1114:	00e6ea63          	bltu	a3,a4,1128 <free+0x4a>
{
  ...
  freep = p;
    ...
    1156:	eaf73f23          	sd	a5,-322(a4) # 2010 <freep>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11b0:	e6490913          	addi	s2,s2,-412 # 2010 <freep>
  if(p == SBRK_ERROR)
    11b4:	5afd                	li	s5,-1
    ...
    11c4:	ec878793          	addi	a5,a5,-312 # 2088 <base>
    11c8:	00001717          	auipc	a4,0x1
    11cc:	e4f73423          	sd	a5,-440(a4) # 2010 <freep>
