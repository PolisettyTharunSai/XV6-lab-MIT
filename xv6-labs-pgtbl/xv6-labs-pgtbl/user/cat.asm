...
cat(int fd)
{
  ...
  2c:	85ca                	mv	a1,s2
  2e:	4505                	li	a0,1
  30:	384000ef          	jal	3b4 <write>
  34:	fe9502e3          	beq	a0,s1,18 <cat+0x18>
      fprintf(2, "cat: write error\n");
  38:	00001597          	auipc	a1,0x1
  3c:	97858593          	addi	a1,a1,-1672 # 9b0 <malloc+0x100>
  40:	4509                	li	a0,2
  42:	790000ef          	jal	7d2 <fprintf>
      exit(1);
  46:	4505                	li	a0,1
  48:	34c000ef          	jal	394 <exit>
    }
  }
  if(n < 0){
  ...
  62:	96a58593          	addi	a1,a1,-1686 # 9c8 <malloc+0x118>
  66:	4509                	li	a0,2
  68:	76a000ef          	jal	7d2 <fprintf>
    exit(1);
  6c:	4505                	li	a0,1
  6e:	326000ef          	jal	394 <exit>
...
main(int argc, char *argv[])
{
  ...
  c8:	f39ff0ef          	jal	0 <cat>
    exit(0);
  cc:	4501                	li	a0,0
  ce:	2c6000ef          	jal	394 <exit>
      fprintf(2, "cat: cannot open %s\n", argv[i]);
  d2:	00093603          	ld	a2,0(s2)
  d6:	00001597          	auipc	a1,0x1
  da:	90a58593          	addi	a1,a1,-1782 # 9e0 <malloc+0x130>
  de:	4509                	li	a0,2
  e0:	6f2000ef          	jal	7d2 <fprintf>
      exit(1);
  e4:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 23a:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 23c:	85ca                	mv	a1,s2
 23e:	1ae000ef          	jal	3ec <fstat>
 242:	892a                	mv	s2,a0
  close(fd);
 244:	8526                	mv	a0,s1
 246:	176000ef          	jal	3bc <close>
  return r;
 24a:	64a2                	ld	s1,8(sp)
}
 24c:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 380:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffeded>
...
000000000000044c <recv>:
.global recv
recv:
 li a7, SYS_recv
 44c:	02000893          	li	a7,32
 ecall
 450:	00000073          	ecall
 ret
 454:	8082                	ret

0000000000000456 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
 456:	02100893          	li	a7,33
 ecall
 45a:	00000073          	ecall
 ret
 45e:	8082                	ret

0000000000000460 <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
 460:	02200893          	li	a7,34
 ecall
 464:	00000073          	ecall
 ret
 468:	8082                	ret

000000000000046a <prac>:
.global prac
prac:
 li a7, SYS_prac
 46a:	02300893          	li	a7,35
 ecall
 46e:	00000073          	ecall
 ret
 472:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4b0:	55450513          	addi	a0,a0,1364 # a00 <digits>
 4b4:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 746:	2beb8b93          	addi	s7,s7,702 # a00 <digits>
 ...
 7a8:	25490913          	addi	s2,s2,596 # 9f8 <malloc+0x148>
        for(; *s; s++)
