...
forktest(void)
{
  ...
  36:	42e50513          	addi	a0,a0,1070 # 460 <prac+0xa>
  ...
  58:	45c50513          	addi	a0,a0,1116 # 4b0 <prac+0x5a>
  5c:	fa5ff0ef          	jal	0 <print>
    exit(1);
  60:	4505                	li	a0,1
  62:	31e000ef          	jal	380 <exit>
      exit(0);
  ...
  6e:	40650513          	addi	a0,a0,1030 # 470 <prac+0x1a>
  ...
  80:	40c50513          	addi	a0,a0,1036 # 488 <prac+0x32>
  ...
  b0:	3f450513          	addi	a0,a0,1012 # 4a0 <prac+0x4a>
...
stat(const char *n, struct stat *st)
{
 ...
 226:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 228:	85ca                	mv	a1,s2
 22a:	1ae000ef          	jal	3d8 <fstat>
 22e:	892a                	mv	s2,a0
  close(fd);
 230:	8526                	mv	a0,s1
 232:	176000ef          	jal	3a8 <close>
  return r;
 236:	64a2                	ld	s1,8(sp)
}
 238:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 36c:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff035>
