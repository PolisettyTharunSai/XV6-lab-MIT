...
main(int argc, char **argv)
{
  ...
  2c:	302000ef          	jal	32e <kill>
  for(i=1; i<argc; i++)
  30:	04a1                	addi	s1,s1,8
  32:	ff249ae3          	bne	s1,s2,26 <main+0x26>
  exit(0);
  36:	4501                	li	a0,0
  38:	2c6000ef          	jal	2fe <exit>
  3c:	e426                	sd	s1,8(sp)
  3e:	e04a                	sd	s2,0(sp)
    fprintf(2, "usage: kill pid...\n");
  40:	00001597          	auipc	a1,0x1
  44:	8e058593          	addi	a1,a1,-1824 # 920 <malloc+0x106>
  48:	4509                	li	a0,2
  4a:	6f2000ef          	jal	73c <fprintf>
    exit(1);
  4e:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 1a4:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1a6:	85ca                	mv	a1,s2
 1a8:	1ae000ef          	jal	356 <fstat>
 1ac:	892a                	mv	s2,a0
  close(fd);
 1ae:	8526                	mv	a0,s1
 1b0:	176000ef          	jal	326 <close>
  return r;
 1b4:	64a2                	ld	s1,8(sp)
}
 1b6:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2ea:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffefed>
...
00000000000003b6 <recv>:
.global recv
recv:
 li a7, SYS_recv
 3b6:	02000893          	li	a7,32
 ecall
 3ba:	00000073          	ecall
 ret
 3be:	8082                	ret

00000000000003c0 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
 3c0:	02100893          	li	a7,33
 ecall
 3c4:	00000073          	ecall
 ret
 3c8:	8082                	ret

00000000000003ca <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
 3ca:	02200893          	li	a7,34
 ecall
 3ce:	00000073          	ecall
 ret
 3d2:	8082                	ret

00000000000003d4 <prac>:
.global prac
prac:
 li a7, SYS_prac
 3d4:	02300893          	li	a7,35
 ecall
 3d8:	00000073          	ecall
 ret
 3dc:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 41a:	52a50513          	addi	a0,a0,1322 # 940 <digits>
 41e:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6b0:	294b8b93          	addi	s7,s7,660 # 940 <digits>
 ...
 712:	22a90913          	addi	s2,s2,554 # 938 <malloc+0x11e>
        for(; *s; s++)
