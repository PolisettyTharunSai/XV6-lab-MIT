...
main(int argc, char *argv[])
{
  ...
  34:	910a8a93          	addi	s5,s5,-1776 # 940 <malloc+0x100>
  38:	a809                	j	4a <main+0x4a>
  3a:	4605                	li	a2,1
  3c:	85d6                	mv	a1,s5
  3e:	4505                	li	a0,1
  40:	304000ef          	jal	344 <write>
  for(i = 1; i < argc; i++){
  ...
  6a:	8e258593          	addi	a1,a1,-1822 # 948 <malloc+0x108>
  6e:	4505                	li	a0,1
  70:	2d4000ef          	jal	344 <write>
    }
  }
  exit(0);
  74:	4501                	li	a0,0
  76:	2ae000ef          	jal	324 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1ca:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1cc:	85ca                	mv	a1,s2
 1ce:	1ae000ef          	jal	37c <fstat>
 1d2:	892a                	mv	s2,a0
  close(fd);
 1d4:	8526                	mv	a0,s1
 1d6:	176000ef          	jal	34c <close>
  return r;
 1da:	64a2                	ld	s1,8(sp)
}
 1dc:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 310:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffefed>
...
00000000000003fa <prac>:
.global prac
prac:
 li a7, SYS_prac
 3fa:	02300893          	li	a7,35
 ecall
 3fe:	00000073          	ecall
 ret
 402:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 440:	51c50513          	addi	a0,a0,1308 # 958 <digits>
 444:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6d6:	286b8b93          	addi	s7,s7,646 # 958 <digits>
 ...
 738:	21c90913          	addi	s2,s2,540 # 950 <malloc+0x110>
        for(; *s; s++)
