...
user/_ugetpid:     file format elf64-littleriscv
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3e6:	51650513          	addi	a0,a0,1302 # 8f8 <digits>
 3ea:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 67c:	280b8b93          	addi	s7,s7,640 # 8f8 <digits>
 ...
 6de:	21690913          	addi	s2,s2,534 # 8f0 <malloc+0x10a>
        for(; *s; s++)
